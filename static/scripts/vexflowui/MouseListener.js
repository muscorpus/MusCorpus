...
Vex.UI.MouseListener.prototype.handleEvent = function(evt){
	evt.preventDefault();
	if (this.handler.provisoryTickable && this.handler.provisoryTickable.duration === '32') {
...
Vex.UI.MouseListener.prototype.handleLeftMouseClick = function(evt){
	if(this.handler.currentStave!=null){
		...
		if(this.handler.currentNote==null){
			...
			if (this.handler.provisoryTickable.duration === '32') {
				newNote.note_heads[0].glyph_code = "v5d";
				newNote.note_heads[0].line = 2
			}
